...
/* MUDAR O HEADER DA PAG NO SCROLL */
...
/* dadadadadaddada */
const backToTopButtonColor = document.querySelector('.back-to-top')

function backToTopColor() {
  if (window.scrollY > 4150) {
    backToTopButtonColor.classList.add('end'),
      backToTopButtonColor.classList.remove('show')
  } else {
    backToTopButtonColor.classList.remove('end')
  }
}
/* WHEN SCROLL */
